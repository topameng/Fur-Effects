	...
	*/
	...
	for (UINT layer = 0; layer < m_NumLayers; layer++)
	{
		...
		*/
		...
		//HRESULT hr2 = pTexture->LockRect( 0, &d3dlr, 0, 0 );
		//HRESULT hr2 = pTexture->LockRect(0,&d3dlr,NULL,D3DLOCK_READONLY );
		HRESULT hr2 = pTexture->LockRect(0,&d3dlr,NULL,0 );

		// pitch value should be h * w * 4 = 128 x 4 = 

		//m_Textures[layer]->LockRect( 0, &d3dlr, 0, 0 );
